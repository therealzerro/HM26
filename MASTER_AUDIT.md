...
**Last updated:** 2026-06-02 (BUG-159 — admin image-export PickPosterCard now renders real pair %s; extracted `fetchPairScores` helper shared with `PickDetailModal`; `waitFonts()` parity for pick capture loop)  
