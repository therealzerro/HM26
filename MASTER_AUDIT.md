...
**Decision B (ratified):** acceptance = operator device walkthrough of every consumer screen in light mode (beta-tester bar dropped — channel quiet since May). **Walkthrough pending — the one open item.** Screen list in scope doc §5.
