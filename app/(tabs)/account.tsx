...
const GLOSSARY = [
  { term: 'ZK6™ Engine', def: 'HitMaster\'s proprietary intelligence engine — a multi-dimensional pattern recognition system built on years of public draw data. Signals are ranked by Oracle Score (signal convergence strength) — a description of historical patterns, not a prediction of future draws.' },
