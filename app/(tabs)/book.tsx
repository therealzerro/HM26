...
const m = StyleSheet.create({
  ...
  comboInput: { width: '100%', padding: 12, borderRadius: 9, borderWidth: 1.5, borderColor: theme.colors.border, fontSize: 28, fontWeight: '900', color: theme.colors.text, backgroundColor: theme.colors.surface, marginBottom: 10, fontFamily: 'Courier', letterSpacing: 6, textAlign: 'center' },
...
const s = StyleSheet.create({
  ...
  comboRow: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: theme.colors.surface, borderRadius: theme.borderRadius.lg, borderWidth: 1, borderColor: theme.colors.border, padding: 12, marginBottom: 8, ...theme.shadows.soft },
  comboNum: { fontSize: 20, fontWeight: '900', color: theme.colors.text, letterSpacing: 3, fontFamily: 'Courier', minWidth: 56 },
  ...
  comingCard: { flex: 1, minWidth: 130, backgroundColor: theme.colors.surface, borderRadius: theme.borderRadius.lg, borderWidth: 1, borderColor: theme.colors.border, padding: 12, ...theme.shadows.soft },
