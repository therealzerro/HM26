...
const LEARN_MODULES = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: 'Managing Expectations', body: 'HitMaster provides data-driven analysis so you can choose your signals with full information — it is NOT a guarantee of outcomes. Every draw is independent, and pattern analysis describes drawing history; it does not change the odds of any future draw. ZK6 identifies statistical patterns and signal convergence, but no engine eliminates randomness. Set a fixed budget you are comfortable with and use responsibly, within your means.' },
    ],
  },
];
