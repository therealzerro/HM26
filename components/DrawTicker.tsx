...
const DRAWS: DrawEntry[] = [
  ...
  {state:"MS",label:"MS Midday",time:"1:29 PM",m:809,session:'midday'},
  ...
  {state:"MS",label:"MS Evening",time:"7:29 PM",m:1169,session:'evening'},
  ...
  {state:"AZ",label:"AZ Evening",time:"9:45 PM",m:1305,session:'evening'},
