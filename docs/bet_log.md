...
### 9/15 evening reconciliation — see the 9/15 section below (net **−$68.75**; 795 straight at ME,NH,VT was the untaken Eve pos 1).

### 9/16 midday reconciliation (imported ~afternoon ET — 33 histories rows / 31 jurisdictions, TN Morning+Midday and TX Morning+Day both distinct; MD + PR skipped by convention)

| Set | Midday result | Consequence |
|---|---|---|
| **{3,6,7}** (open leg: 637 S full board + early-13; {3,6,7} B early-13) | absent (ID 397 / TX 365 nearest) | **ride day 2 — stays live tonight** |
| **{2,4,9}** (open leg: full-board BOX) | absent (KS 824 / TX 428 / ON 425 nearest) | **ride day 2 — stays live tonight** |
| {1,6,8} (ride day 3, not carried 9/15) | absent (KY 860 / MI 661 / IN 156 nearest) | **ride day 3 = FINAL tonight**, expires after 9/16 unhit |
| any Evening-board set | none of {1,6,8} {2,4,9} {4,5,7} {3,6,7} {0,1,5} {1,3,5} drew | **no convention closures tonight** |

Boards at midday: Mid K6 **1/6** (pos 5 615 boxed — IN 156), All-Day K6 **0/6** at the midday, Eve K6 0/6 at the midday. Same-day repeats at midday: {0,5,7} twice (ME,NH,VT 057, NC 075), {2,4,8} twice (KS 824, TX 428), {7,8,9} twice (DE 987, IA 798), {0,5,8} again (VA 850 — 5th time since 9/15 midday). None on tonight's boards; recent hotness is anti-predictive (STATE_STR ×3) so nothing is read from it.
...
|---|---|---|---|
| Full board (42 draws, $10.50/u) | STRAIGHT | **637** {3,6,7} — Eve K6 slot 637 = Eve best_order 637 = Mid DI best_order 637 (three-way); All-Day dissent 736 slot / 763 best_order. Evening 90d orders 367:5 / 736:5 / 376:4 / 637:4 / 673:3 / 763:3 — flat. 69 in 180d (0.99×), 40 in 90d, 12 in 30d; evening 90d 24; last 9/11 — clear | 2S = $21.00 |
| Full board | BOX | **{2,4,9}** (any order) — Eve pos 2 (924, best_order 429) + All-Day pos 4 (249); evening 90d orders 492:7 / 429:6 / 924:4 / 294:3 / 942:3 / 249:2 — scattered, box stays the instrument. 70 in 180d (1.01×), 39 in 90d, 14 in 30d; evening 90d 25; last 9/11 — clear | 3B = $31.50 |
| Early-13 (13 draws, $3.25/u) | STRAIGHT | **637** | 2S = $6.50 |
| Early-13 | BOX | **{3,6,7}** (any order) | 3B = $9.75 |

Total **$68.75** (same as 9/15). Rates uniform: ~22.3% box / ~4.1% straight per set on 42; ~7.5% / ~1.3% on the early 13. Expected night ≈ −$6.90 at 90% RTP.

**Operator decision flagged — {1,6,8} on its FINAL ride day is tonight's top convergence** (Eve pos 1 + All-Day pos 3 + Mid DI #1 + all three DI top-30s; 74 in 180d = 1.06×, 42 in 90d, 15 in 30d; evening 90d 19 — NY:3, DC:2; orders 186:5 / 168:4 / 861:4 / 618:2 / 681:2 / 816:2 — scattered → box). It was never carried past the 9/14 late-29 under the 1+1 sizing. Options: (a) leave the ticket as placed (two open legs, convention); (b) add **{1,6,8} 3B full board (+$31.50)** as a third leg for its final day — a sizing widen the operator has to call; (c) swap {1,6,8} B in for {2,4,9} B — NOT the convention (a placed unhit leg rides until day 3), stated only so it is on the record as rejected. No accuracy claim attaches to any of the three — SIGNAL-INFO-01 / ENG-REVIEW-01: convergence chooses *which* set, not the rate.
...
**Reconcile after the evening paste/import (9/17 workflow):** main ticket — any hit on {3,6,7} or {2,4,9} closes that leg (day 2), unhit legs ride into 9/17 as day 3 (final); {1,6,8} expires after tonight either way (its straight 681 sits in the quad). Quad — each pick is a one-night straight on the early 13 (PA SC WV ME,NH,VT TX GA TN MI MN DE OH AR DC; note histories lumps GA/TX/DC night rows with evening, so check draw time on any GA/TX/DC match). **Operator notes 9/16: early-pool PLACEMENT CUTOFF = 7:46pm ET (last time an early-pool bet can be placed); early-pool RESULTS fully displayed by 8:24pm ET.** Earlier entries used ~7:45pm as the "resolves by" time — that is the cutoff, not the readout. The late-29 pool then begins with AZ at 8:45pm. Night at risk: **$94.75**; expected ≈ −$9.50 at 90% RTP. Log running total after 9/14 + 9/15 placed tickets: −$105.00 going in.
...
### 9/14 evening reconciliation (42 draws imported; verified vs histories 2026-09-14 session=evening)

| Leg | Result | Payout |
|---|---|---|
| **Late-29 (PLACED ~4:05pm)** 681 2S | 0 — {1,6,8} absent from the late-29 (OK 318 / CA 018 / IA 661 nearest) | $0 |
| **Late-29 (PLACED)** {4,6,9} 3B | 0 — absent (KY 869 nearest; DE 697 was early-pool) | $0 |
| All-Day ticket evening half (NOT confirmed placed): 681 / 469 / 759 2S+3B | 0/3 — {5,7,9} nearest NJ 779 / LA 977 | $0 |
| All-Day ticket 140 2S+3B (closed at midday) | **{0,1,4} drew AGAIN twice — AZ 014, TX 410** (bet order 140 → box only) | **$225.00 if the 75-draw ticket was bought as one; $0 if the evening half was dropped after the midday close** |

**Late-29 net −$36.25 (confirmed placed).** All-Day 4-leg ticket if bought whole: 140 boxed three times (NM midday + AZ + TX evening) = $337.50 on $375.00 → **net −$37.50**; core-only (681 + 469) −$187.50. Boards 9/14: Eve K6 **1/6** (pos 4 104 boxed twice), All-Day K6 **2/6** (pos 2 490 → W.Canada 409; pos 6 140 ×3), Mid K6 0/6. **Rides after 9/14: 469 → day 3 (FINAL, expires after tonight unhit); 681 → day 2; 759 → day 2; 140 CLOSED (hit).**
...
| Instrument | Combo | Set | Basis |
|---|---|---|---|
| **STRAIGHT** | **637** | {3,6,7} | Top convergence tonight: Eve pos 6 + All-Day pos 6, DI in all three scopes, Eve DI #2 six perms, evening BOX signal 0.968 / CO 0.955 (highest on the board). Order 637 = Eve K6 slot + Eve best_order + Mid DI best_order (three-way); dissent 736 = All-Day slot + All-Day best_order. Orders 90d all-session: 763:10 / 736:7 / 367:7 / 376:7 / 637:5 / 673:5; evening 90d: 736:5 / 367:5 / 637:4 / 376:4 / 763:3 / 673:3 — flat (STATE_STR ×3: order frequency carries nothing). 69 in 180d (0.99×), 41 in 90d, 12 in 30d; evening 90d 24 (≈ expectation 22); footprint 90d evening: AR 3, WV 2, MI 2, DC/OH/PA/DE/MN 1 — 12 of 24 inside early-13 jurisdictions (texture; ENG-PERSTATE-P0). |
| **BOX** | **{4,6,9}** | any order | **RIDE day 3 of 3 (final).** Off the K6 by rotation, but DI #1 on both All-Day and Evening for the third straight day with all six perms in both top-30s — the strongest DI stack in the log's history of this set. Orders scattered (evening 90d 946:6 / 496:5 / 694:5 / 649:3 / 469:3 / 964:3; best_order 694 All-Day vs 964 Evening) → box is the instrument. 75 in 180d (1.08×), 39 in 90d, 12 in 30d; evening 90d 25; last 9/9 evening — clear. |

**Early-13 pool (PA SC WV ME,NH,VT TX GA TN MI MN DE OH AR DC, resolves ~6:25–7:46pm ET; 13 draws, $3.25/unit):**

| Instrument | Combo | Set | Basis |
|---|---|---|---|
| **STRAIGHT** | **637** | {3,6,7} | Same order as the full board — extra units on the pool where half of the set's evening draws have landed (texture, not a lever). |
| **BOX** | **{3,6,7}** | any order | Covers the five non-637 orders of the straight set on the early pool — the one place the full-board ticket leaves {3,6,7} box-uncovered; a 736 or 367 early pays here, nothing on the full board. Swap: {4,6,9} if the operator prefers to scale the final ride instead. |

**Amend rule after the 9/15 midday close (operator paste → import → check):** if {3,6,7} draws at midday → closed by convention → **swap to 924 straight / {2,4,9} box** (Eve pos 5 + All-Day pos 2; 924 = Eve K6 slot; 249 = All-Day slot + All-Day best_order; 429 = Eve best_order and most-drawn 90d 429:10). If {4,6,9} draws at midday → its leg is closed (hit, no payout unless a midday ticket existed) → full-board box becomes **{2,4,9}**. If {1,6,8} or {5,7,9} draw at midday → those rides close; otherwise 681 and 759 are NOT carried tonight under the 1+1 sizing (operator override: add 3B on either at $31.50). Not taken: 795 {5,7,9} (Eve pos 1 overdue ds 21 evening, ride day 2, All-Day DI 7/9/18/27 — the 4th consecutive session it is the engine's evening rank-1 miss candidate); 805 {0,5,8} (Eve pos 3, Eve DI 11/20/22/26 four perms, All-Day DI 29; single-board); 973 {3,7,9} (Eve pos 4, Eve DI 7/8/21; 79 in 180d = 1.14×, 20 in 30d — count leader, texture); 196 {1,6,9} (Eve pos 2, single-board, Eve DI 13/28); 618/681 {1,6,8} (Mid-board only tonight; DI all three scopes; ride day 2 — natural third leg if sizing widens).

### 9/15 midday reconciliation (imported ~3:40pm ET from the operator's paste — 33 histories rows / 31 jurisdictions, TN Morning+Midday and TX Morning+Day both distinct; MD + PR skipped by convention; hit-detection ran, 3 hits stamped)
...
| {5,7,9} (ride day 2, not carried) | absent (TX 997 / VA 578 nearest) | ride stays open, still not on tonight's ticket |
...
- Full board, 42 draws: single set **~22.3% P(≥1 box)**, **~4.1% P(≥1 straight)**. Two distinct sets: ~39.6% ≥1 box on either; ~8.0% ≥1 straight on 637 or box-and-straight events combined.
- Early-13, 13 draws: {3,6,7} ~7.5% any box, ~1.3% straight 637.
- At the recent 2S + 3B sizing: full board 2S 637 ($21.00) + 3B {4,6,9} ($31.50) = $52.50; early-13 2S 637 ($6.50) + 3B {3,6,7} ($9.75) = $16.25; **$68.75 total**. Payouts per hitting state: straight $225/unit, box $37.50/unit. Expected night ≈ −$6.90 at 90% RTP.
- EV framing: all products ≈ 90% RTP; convergence + DI stacking + ride discipline chose *which* combos, not the rate. No positional filter (ENG-MIDDAY-POS-02); no per-state targeting (ENG-PERSTATE-P0); cross-scope overlap used as the operator's cross-reference feature.
- Ride convention: 469 expires after tonight unhit; {3,6,7} opens as day 1.

### 9/15 evening reconciliation (42 draws imported by the 9/16 workflow; verified vs histories 2026-09-15 session=evening)

| Leg | Result | Payout |
|---|---|---|
| **Full board 637 STRAIGHT 2S ($21.00)** | 0 — {3,6,7} absent from all 42 evening draws (NJ 373 / QC 733 / OH 397 / MI 643 nearest) | $0 |
| **Full board {2,4,9} BOX 3B ($31.50)** | 0 — absent (CA 402 / IA 829 / NM 468 nearest) | $0 |
| **Early-13 637 STRAIGHT 2S ($6.50)** | 0 — {3,6,7} absent from the 13-draw pool | $0 |
| **Early-13 {3,6,7} BOX 3B ($9.75)** | 0 — absent | $0 |

**Net: −$68.75 (confirmed placed).** Boards 9/15 final: Eve K6 **3/6** — **pos 1 795 STRAIGHT at ME,NH,VT** (an early-13 jurisdiction), pos 3 805 boxed twice (IN 085, TX 850; also twice at midday — closed by convention, never a leg), pos 4 973 (OH 397); All-Day K6 **3/6** (415 CA + 758 VA at midday, 485 → ID 548 evening); Mid K6 1/6. The untaken Eve pos 1 — "the 4th consecutive session it is the engine's evening rank-1 miss candidate" — was the straight. Selection variance inside a 6-slot board, exactly the SIGNAL-INFO-01 shape; not a lever (no slot predicts the hitting slot). **Rides after 9/15: 759 {5,7,9} CLOSED by hit (day 2, never carried → forfeit, no payout); 681 → day 3 (FINAL 9/16); {3,6,7} → day 2; {2,4,9} → day 2; 469 already CLOSED at the 9/15 midday.** Log running total, 9/14 + 9/15 placed tickets: −$105.00.

Reconciled 2026-09-16 (see the 9/15 evening reconciliation above).

## 2026-09-14 — ALL-DAY session (Monday full boards: 33 midday + 42 evening = 75 draws → $18.75/unit per leg per bet type; every recent Monday 8/17–9/8 imported 33 + 42) — PROPOSED 4 legs, every leg 2S + 3B — $375.00 (2-leg core 681 + 469 = $187.50; 1S + 1B sizing = $150.00) — asked ~6:40am ET; confirm placement + units from the ticket — MIDDAY HALF RECONCILED ~3:55pm ET (140 BOX at NM 041, +$112.50 if placed; 681 / 469 / 759 blank) — LATE-POOL ticket (after 7:45pm, 29 draws) PLACED ~4:05pm ET: STRAIGHT 681 2S + BOX {4,6,9} 3B = $36.25

Slate basis: 9/14 K6 (workflow run ~6:34am ET, engine v2.1). Snapshot orders as stored: All-Day K6 = 136 / 490 / 681 / 759 / 469 / 140; Evening K6 = 795 / 196 / 681 / 104 / 805 / 469; Midday K6 = 316 / 054 / 571 / 824 / 618 / 615. All 18 slots singles. Cross-scope: **{1,6,8} = All-Day pos 3 + Eve pos 3 + Mid pos 5 — TRIPLE overlap (ninth in the log), Mid DI #1**; **{4,6,9} = All-Day pos 5 + Eve pos 6, DI #1 on both boards (six perms each) for the second day**; {5,7,9} = All-Day pos 4 + Eve pos 1; {0,1,4} = All-Day pos 6 + Eve pos 4; {1,3,6} = All-Day pos 1 + Mid pos 1 (double rank-1, eighth day). 3-day block scan (9/11–9/13, all sessions): every set on all three K6 boards is clear ({0,1,4} last drew 9/10 midday NM 410 — one day outside the window). Bases (all sessions, excl. PR/MD): 11,600 draws in 180d → a single set expects 69.6; 90d 6,648 → 39.9; 30d 2,203 → 13.2.

### 9/13 evening reconciliation (38 draws imported ~6:33am ET — one short of the 39 Sunday board: IA evening is missing from the import; check it before the next receipts)

| Leg | Result | Payout |
|---|---|---|
| **469** 3B full board (39 → 38 draws) | 0 — {4,6,9} absent from every evening draw | $0 |
| **469** 2S early-11 | 0 — no {4,6,9} order in the early pool | $0 |
| **248** 3B early-11 | 0 — {2,4,8} absent from the early pool | $0 |

**Net: −$43.00.** The unplaced #2, **830 {0,3,8}, BOXED at OK 308** (would have paid $112.50 on the proposed 3B — the 2-leg core 469 + 830 would have netted +$15.00; symmetric noise, recorded not actionable). Boards 9/13 evening: Eve K6 1/6 (pos 1 830), All-Day K6 1/6 (pos 6 038 — same draw), Mid K6 0/6 at the evening. {0,3,8} enters the 3-day block (9/14–9/16); it is off every board today. Rides: **469 unhit → day 2** (carried below); 861/618 and 248 were early-pool / unconfirmed tickets only — no full-board carry, so both re-enter as fresh legs where the boards support them.

### Positions — PROPOSED, ALL-DAY board (75 draws, $18.75/unit), every leg 2S + 3B ($93.75/leg) — total $375.00

| Combo (straight order) | Set | Provenance | Units | Cost | If straight hits (per state) | If box-only hits (per state) |
|---|---|---|---|---|---|---|
| **681** (All-Day K6 slot + All-Day DI row 6 + All-Day best_order + Eve K6 slot — four-way; 618 = Mid K6 slot + Mid DI #1 + most-drawn 90d 618:10 — hold 618 instead if the 9/13 midday 618 ticket was placed and is riding) | {1,6,8} | **TRIPLE overlap: All-Day pos 3 + Eve pos 3 + Mid pos 5; DI in all three scopes** (Mid DI 1/10/12/19/25 — five perms, rank-1; All-Day DI 6/10; Eve DI 4/8/27). 74 in 180d (1.06×), 42 in 90d, 15 in 30d; footprint 90d MS 4, AZ/IN/NM/NY 3; last 9/9 midday MS 168 + NJ 186 — clear. Orders 90d: 618:10 / 168:8 / 186:8 / 816:7 / 861:5 / 681:4 (681 is the least-drawn — texture; the K6/DI stack is the basis). | 2S + 3B | $93.75 | $562.50 | $112.50 |
| **469** (All-Day K6 slot + Eve K6 slot + All-Day DI rank-1 row + Eve DI rank-1 row — the same four-way as last night; best_order fields 694 / 964 are the derived swaps, BUG-155) | {4,6,9} | **RIDE day 2** (9/13 evening full-board 3B blank). **All-Day pos 5 + Eve pos 6; DI #1 on BOTH boards with all six perms in the top 30** (All-Day 1/2/3/5/12/23, Eve 1/2/14/16/20/24, energy 100) — second consecutive day as the only double rank-1 DI set. 75 in 180d (1.08×), 39 in 90d, 13 in 30d; footprint 90d AZ/NC/NM/TX/WA 3; last 9/9 evening WA 496 + W.Canada 694 — clear. Orders 90d flat: 649:8 / 469:7 / 496:7 / 946:7 / 694:5 / 964:5. | 2S + 3B | $93.75 | $562.50 | $112.50 |
| **759** (All-Day K6 slot + All-Day DI row 7; 795 = Eve K6 slot + best_order both scopes but the least-drawn order 795:3; 579 = most-drawn 579:11) | {5,7,9} | **All-Day pos 4 + Eve pos 1 (overdue tag, evening ds 20)**; All-Day DI 7/8/16/27 (four perms), Eve DI 10; off the Mid board/DI. 75 in 180d (1.08×), 40 in 90d, 16 in 30d (10 of them midday — texture, STATE_STR ×3); footprint 90d DC/MO/NJ 3; last 9/9 midday NM 579 — clear. Orders 90d: 579:11 / 759:9 / 975:9 / 957:5 / 597:3 / 795:3. | 2S + 3B | $93.75 | $562.50 | $112.50 |
| **140** (All-Day K6 slot + All-Day best_order + co-most-drawn 90d 140:8 = 401:8; 104 = Eve K6 slot + Eve best_order) | {0,1,4} | **All-Day pos 6 + Eve pos 4**; All-Day DI 9/11, Eve DI 12/17/18/28 (four perms); off the Mid board/DI. 70 in 180d (1.01×), 40 in 90d, 12 in 30d; footprint 90d IA/MI/NY 4, ME,NH,VT/NM/TX 3 — the widest of the four; last 9/10 midday NM 410 (9/8 evening CO 140 + NE 401) — clear by one day. Orders 90d: 140:8 / 401:8 / 014:7 / 104:7 / 410:7 / 041:3. | 2S + 3B | $93.75 | $562.50 | $112.50 |

Named swap: **136 / 316 {1,3,6}** — All-Day pos 1 + Mid pos 1 (double rank-1 for the eighth day, overdue tag both, ds 26 / 29), All-Day DI 4/19/25, Mid DI 31 (just outside the top 30); 57 in 180d (0.82×), 27 in 90d, **2 in 30d**, last 8/19 evening MO 316 — coldest set on any board; overdue/reversion measured FLAT (COHORT-01), so the cold stretch is neither a reason for nor against — the swap is for the operator who wants the double rank-1 slot over 140's double overlap. Not taken: 490 {0,4,9} (All-Day pos 2 only, DI 13/21/24, single-board; 72/180d, last 9/7 NJ 049 — clear); 248 {2,4,8} (OFF the All-Day K6 board — Mid pos 4 + Eve DI 3/5/6/7/22 five perms + All-Day DI 18/26/28; 95 in 180d = 1.36×, 25 in 30d — count leader, texture per the 9/11 persistence test; last 9/8 DC 248 — clear; the 9/13 early-pool box was session-only, no carry — the natural fifth leg or the swap for 759 if the operator wants the Eve DI stack); 196 / 805 / 054 / 571 / 615 (single-board, no All-Day slot). No double this session: every DI top-30 row in all three scopes is a single.

### Session math (uniform baseline — standing BUG-162 / SIGNAL-INFO-01 / ENG-ALLDAY-RAND-01 truth; Monday full boards)

- Singles on 75 draws: **~36.3% P(≥1 box) each, ~7.2% straight** — the All-Day K=6 pinned rate (pick 36% / slate 93.4%).
- 4-leg ticket: ~83.6% P(≥1 box on any leg), ~25.9% P(≥1 straight on any leg), ~16.4% blank session. 2-leg core (681 + 469): ~59.5% / ~13.9% / ~40.5% blank.
- Staked: **$375.00** (4 legs × $93.75) or **$187.50** for the 2-leg core; at 1S + 1B per leg, $150.00 / $75.00. Expected session ≈ −$37.50 / −$18.75 at 90% RTP. One box-only hit ($112.50) covers neither ticket; two boxes cover the core; one straight ($562.50) covers the full ticket. Multiple hits on one leg pay per hitting state.
- The book prices the midday half at $8.25/unit (33 draws) and the evening half at $10.50/unit (42) — placing the two sessions separately costs the same $18.75/unit and lets a midday hit close a leg before the evening half is bought (the 7/22 post-mortem interaction: an All-Day-sourced leg closed at midday forfeits exactly the evening exposure; EV-neutral, the operator's call).
- EV framing: all products ≈ 90% RTP; DI stacking + cross-board depth chose *which* combos, not the rate. No positional filter (ENG-MIDDAY-POS-02); no per-state targeting (ENG-PERSTATE-P0). Calibration payload = 7/24 fit — not quoted.
- Ride convention: 469 is day 2 today (expires after 9/15 unhit); 681 / 759 / 140 are day 1. A hit on either half closes the leg.

Reconcile after the 9/15 workflow import (midday half resolves by ~3:30pm ET; operator paste welcome). Import note: 9/13 evening imported 38 of 39 — IA evening absent.

### 9/14 midday reconciliation (imported ~3:55pm ET from the operator's paste — 32 histories rows for 33 draws: TX Morning and TX Day both drew 821, and the histories key collapses same-digit/same-session repeats into one row; MD + PR skipped by convention; ticket NOT confirmed placed — figures assume the proposal as logged)

| Leg | Result | Payout |
|---|---|---|
| **140** 2S+3B | **BOX — NM drew 041** (bet order 140, box only) | **$112.50** |
| 681 2S+3B | 0 — {1,6,8} absent (GA 867 / NJ 817 nearest) | $0 |
| 469 2S+3B | 0 — {4,6,9} absent (AZ 849 / NY 697 nearest) | $0 |
| 759 2S+3B | 0 — {5,7,9} absent (FL 753 / VA 971 nearest) | $0 |

**Midday half: +$112.50 against the $375.00 all-day stake if placed as proposed (2-leg core 681 + 469: blank).** **140 leg CLOSED by hit** — the evening exposure on {0,1,4} is forfeited by convention (the 7/22 interaction; Eve pos 4 104 stays on the engine board but is off every ticket tonight). Named swap 136/316 {1,3,6}: blank (OH 731 nearest). Boards at midday: All-Day K6 1/6 (pos 6 140), Mid K6 0/6 (824 vs TX 821, 571 vs FL 753 nearest), Eve K6 0/6 at the midday — **no evening-board set drew at midday, so nothing new enters the 3-day block for tonight.** Rides: 469 unhit → still day 2 (expires after 9/15); 681 / 759 day 1, unhit; 248 (Mid pos 4, off the ticket) blank.

### (L) LATE POOL — draws after 7:45pm ET (late-29: AZ 8:45 · QC 8:50 · IA 8:58 · IN 8:59 · NE/FL/CO/CA 9:15 · WI 9:30 · MO 9:40 · OK/ID 9:45 · KS 9:55 · NY/MS 10:00 · IL 10:05 · CT 10:14 · ON 10:15 · LA 10:25 · WA/VA 10:30 · NJ 10:40 · KY 10:45 · NC 10:50 · TX Night 10:55 · NM 11:15 · W.Canada + GA Night + DC Night = 29 draws → **$7.25/unit**; the early-13 pool (PA SC WV ME,NH,VT TX GA TN MI MN DE OH AR DC) is excluded) — 1 STRAIGHT + 1 BOX — asked ~3:50pm ET, **PLACED ~4:05pm ET on the operator's word ("log these"): 681 2S ($14.50) + {4,6,9} 3B ($21.75) = $36.25**

**Proposed: STRAIGHT 681 {1,6,8} · BOX {4,6,9} (any order).** Same-set flip (straight 469 + box {1,6,8}) is equal on the rate; the pairing is decided by order evidence — see the tie-break.

| Instrument | Combo | Set | Basis |
|---|---|---|---|
| **STRAIGHT** | **681** | {1,6,8} | **TRIPLE overlap today — All-Day pos 3 + Eve pos 3 + Mid pos 5 (ninth triple in the log)**, DI in all three scopes (Eve DI 4/8/27, All-Day DI 6/10, Mid DI #1 five perms). **Order 681 is a five-way agreement: All-Day K6 slot + Eve K6 slot + All-Day DI row 6 + All-Day best_order + Eve DI row 4** (dissent: Eve best_order 861, Mid K6/DI 618 — the derived fields, BUG-155). Late-pool texture: 32 in 180d vs 30.2 expected (1.06× — flat), 16 in 90d, 7 in 30d; footprint 90d NY 3, DC 2, then AZ/CT/IN/LA/MO/MS/NC/NJ/NM/ON/TX 1 each — 13 of the 29; last late-pool 9/8 ON 186, last anywhere 9/9 midday (MS 168 / NJ 186) — clear of 9/11–9/14 (midday today: GA 867 / NJ 817 brushed it 2-of-3). Late-pool orders 90d: 186:5 / 168:4 / 861:3 / 681:2 / 618:1 / 816:1 — 681 is a low-drawn order in this pool (texture; STATE_STR ×3 says order frequency carries nothing). Swaps: 861 (Eve best_order) / 186 (pool most-drawn). |
| **BOX** | **469** (bet any order; 946 / 694 / 496 / 649 / 469 / 964 all live in the pool) | {4,6,9} | **RIDE day 2** (9/13 evening full-board 3B blank; expires after 9/15 unhit). **Eve pos 6 + All-Day pos 5; DI #1 on BOTH boards with all six perms in the top 30 (Eve 1/2/14/16/20/24, All-Day 1/2/3/5/12/23, energy 100) — third consecutive day as the only double rank-1 DI set.** Late-pool texture: 38 in 180d vs 30.2 (1.26×), 21 in 90d, 7 in 30d; footprint 90d **AZ 3, WA 3**, CO/IN/NM/TX 2, DC/ID/IL/KS/MO/NC/W.Canada 1 — 13 of the 29 (AZ is the first late draw, 8:45pm); last 9/9 evening WA 496 + W.Canada 694 (both late-pool) — clear (midday today: AZ 849 / NY 697 brushed it). Late-pool orders 90d are SCATTERED — 946:6 / 694:5 / 496:4 / 649:3 / 469:2 / 964:1 (180d: 694:11 / 496:9 / 469:6 / 946:6) — the engine order 469 is second-least-drawn here, so the box is the right instrument for this set tonight. |

**Tie-break (why the straight goes on 681 and the box on {4,6,9}, not the reverse):** both sets sit at the uniform rate — ~16.0% P(box) and ~2.9% P(straight) on 29 draws whichever is chosen (BUG-162 / SIGNAL-INFO-01; pool persistence measured flat 9/13). What differs is the order evidence: {1,6,8} has one order five engine surfaces agree on (681); {4,6,9} has the strongest SET stack on the boards (double rank-1 DI, six perms each) but its orders are spread across all six in the pool and its engine order is near the bottom. A straight needs a consensus order; a box does not. Hence 681 straight / {4,6,9} box. Flip (469 straight / {1,6,8} box) if you'd rather put the 6× instrument on the DI-#1 ride — 469 is still a four-way engine order (Eve K6 + All-Day K6 + both DI rank-1 rows), the rate is identical, only the pool-order texture is weaker. Last night's straight was 469 on the early pool (blank); this is not a reversal of that read, it is the same rule applied to tonight's stack (681 was not a five-way order on 9/13 — Eve K6 held 861 then).

Not taken: **{2,4,8}** (Eve DI 3/5/6/7/22 five perms + Mid pos 4 — OFF the Eve/All-Day K6 boards; late-pool count leader 55/180d = 1.82×, 17 in 30d = 3.0× — texture per the 9/11 + 9/13 persistence tests; orders perfectly scattered 248/284/482/842:7 each; last 9/8 DC 248 — clear; the natural third leg as a box if the operator wants a second box); **{0,5,8}** 805 (Eve pos 5, Eve DI 9/19/21/23/29 five perms, single-board; 45/180d 1.49×, pool order 805:7 leads — the runner-up straight, engine + DI + best_order + pool-most-drawn all say 805; last 9/9 MS 805 — clear); **{5,7,9}** 795 (Eve pos 1 overdue ds 20 + All-Day pos 4; 34/180d flat, 5 in 30d, last late 8/25; orders flat 579/759/975:4, 795:2 — no order consensus, overdue FLAT per COHORT-01); {1,6,9} 196 (Eve pos 2 only, orders flat); {0,4,9} 490 / {1,3,6} 136 (All-Day-only; 136 = 1 in 30d, cold). **{0,1,4} 104 OFF — closed by the NM 041 midday box.** No positional filter (ENG-MIDDAY-POS-02); no per-state targeting (ENG-PERSTATE-P0) — footprints above are evidence for *which set*, never for a state bet. TX/GA/DC pool counts include both of their evening draws (the ledger cannot split early from late).

**Positions — PLACED ~4:05pm ET (late-29 pool, $7.25/unit; shape matches the 9/13 early-pool ticket)**

| Leg | Set | Units | Cost | If straight hits (per state) | If box-only hits (per state) |
|---|---|---|---|---|---|
| **681** | {1,6,8} | 2S | $14.50 | $450.00 | — |
| **469** box | {4,6,9} | 3B | $21.75 | — | $112.50 |

**Total staked: $36.25.** Straight-only on 681 (a 186 / 861 / 168 draw pays nothing on this ticket); box-only on {4,6,9} (any order pays $112.50 per hitting state). Session math on 29 draws (uniform): ~18.4% that the ticket pays anything, ~2.9% the straight, ~16.0% the box; expected ≈ −$3.60 at 90% RTP. If the all-day 4-leg ticket was placed this morning, both sets are already covered on these 29 as part of the 75 — this stacks on top (a 681 draw pays both tickets; a {4,6,9} draw pays the box here plus the 469 box leg, and 469 straight there). Session-only, no carry beyond the ride rules (469 ride day 2 continues on the 9/13 full-board leg; 681 day 1). Reconcile against the late-29 after the 9/15 import (operator paste welcome; last draw NM 11:15pm ET).
...
### (A) Early pool — SUNDAY = 11 draws (PA SC ME,NH,VT GA TN MI MN DE OH AR DC → $2.75/unit; TX and WV are the only early-pool jurisdictions dark on Sunday — GA and DC each keep their early draw, their second draw is late; 8/30 + 9/6 both confirm 11) — PLACED ~5:20pm ET on the operator's word: **469 2S ($5.50) + 248 3B ($8.25) = $13.75** (bet order 469; 248 boxed); session-only, no carry; reconcile against the 11 early draws (~7:45pm ET). Deep-scope study below

**Proposed: STRAIGHT 469 {4,6,9} · BOX {2,4,8} (any order).** Same-set flip (box {4,6,9} + straight 248) is equal on the rate; the pairing is decided by order evidence, not set strength — see the tie-break.

| Instrument | Combo | Set | Basis |
|---|---|---|---|
| **STRAIGHT** | **469** | {4,6,9} | The only combo today whose ORDER is a four-way agreement: Eve K6 slot = 469, All-Day K6 slot = 469, Eve DI rank-1 row = 469, All-Day DI rank-1 row = 469 (best_order fields say 964 / 694 — those are the derived fields, BUG-155, not the rows). Set: DI #1 on both boards with all six perms in the top 30 (Eve 1/2/18/22/24/29, All-Day 1/2/3/5/15/27, energy 100), Eve pos 5 + All-Day pos 5; was DI #1 both boards on 9/9 and drew that night (WA 496, W.Canada 694), blocked 9/10–9/12, back at #1 on its first eligible day. Pool texture: 11 in 180d vs 12.0 expected (flat), 5 in 90d, 1 in 30d, last pool 8/25 MI 469; pool orders 469:4 / 496:3 / 964:2 / 649:1 / 946:1 — 469 is also the pool's most-drawn order (texture). Footprint 90d: DC/DE/MI/PA/SC 1 each. Clear of 9/10–9/13. Swaps: 964 (Eve best_order) / 694 (All-Day best_order + most-drawn evening 694:11 / 469:10 / 496:10). |
| **BOX** | **248** (bet any order; 482 / 824 / 842 / 284 / 248 are all live in the pool) | {2,4,8} | Eve pos 4 + Mid pos 6; Eve DI 3/5/6/10/27 (five perms), Eve DI 2 yesterday with six; All-Day DI 23. RIDE day 1 (midday leg blank). Pool: **19 in 180d vs 12.0 (z +2.0), 12 in 90d vs 7.0 (z +1.9)**, 2 in 30d (cooled), Sunday 1; footprint 90d DC 3, GA 3, PA 2, AR/DE/MN/SC 1 — seven of tonight's eleven; 180d DC 7 (incl. two 248s: 8/1 and 9/8), GA 5, DE 5, PA 4; last pool 9/8 DC 248, last anywhere same — clear. Pool orders are SCATTERED (482:5 / 824:5 / 842:4 / 284:3 / 248:2; evening overall 842:14 / 482:13 / 824:11 / 248:9) — no order consensus, so the box is the right instrument for this set. |

**Tie-break (why the straight goes on 469 and the box on {2,4,8}, not the reverse):** both sets sit at the uniform rate — ~6.4% P(box) and ~1.1% P(straight) on 11 draws whichever is chosen (BUG-162 / SIGNAL-INFO-01 truth; pool persistence measured flat tonight, below). The only thing that differs between the two is order evidence: {4,6,9} has one order that every engine surface agrees on (469), {2,4,8} has five orders spread almost evenly across the pool and the evening stream. A straight needs a consensus order; a box does not. Hence 469 straight / {2,4,8} box. Flip if you'd rather put the 6× instrument on the DI-#1 set — the rate is the same, only the order logic is weaker (248 = engine + DI order, but it is the LEAST-drawn order of the five in the pool).

**Deep-scope findings (Sunday-live early pool, 11 jurisdictions, evening draws 3/17–9/12; GA/DC counts include both of their evening draws — the ledger cannot split early from late for those two):**
- Base: 1,994 pool draws in 180d → a single expects 12.0 (90d 1,173 → 7.0; 30d 389 → 2.3; 22 Sundays / 279 draws → 1.7).
- **Pool persistence is FLAT.** All 120 singles, prior-150d count → last-30d count: corr **0.002**; by quartile of prior count the last-30 average is 2.53 / 2.37 / 2.33 / 2.17 per set (expected 2.33 each — within noise). Mid-60d → last-30d: corr 0.057, quartiles 2.43 / 2.50 / 2.17 / 2.30. Pool "hot" lists carry no forward rate — same verdict as the 9/11 full-board persistence test (1.04×).
- **Sunday-only counts are noise.** Split the 22 Sundays in half: corr(first 11, last 11) = **−0.14**; the top-20 sets by first-half Sunday count averaged 0.75 draws in the second half vs 1.03 for all sets. So {0,6,7} Sunday 7 and {1,5,9} Sunday 7 (z ≈ +4 each) are not signals.
- Universe pool leaders (texture only, per the above): {0,1,7} 22/180d (z +2.9, off every board, last pool 9/5); {1,2,7} 19 with 16/90d (z +3.4) — BLOCKED, drew 9/12 (also {1,2,8} 19 — drew 9/12); {2,4,8} 19 (the only board-backed set in the top 5); {3,5,7} 18 (closed by the 9/12 hit); {2,4,7} 18 (off boards); {5,8,9} 16 with 13/90d (z +2.3) + 6/30d — hot, Eve DI fading 4 → 10 → 20 across 9/7 → 9/13, off K6; pool orders 958:6.
- Engine sets in the pool: {4,6,9} 11 (flat); {0,3,8} 12 / 4 in 90d (flat, 038:5 leads); {1,6,8} 9 / 5 (below, 816:3 leads); {0,6,7} 16 / 10 (Mid pos 4 today, blank at midday; Eve DI absent today, fading 8 → 10 → 17 → out); {5,7,9} 13 / 6 (All-Day pos 4 only); {1,3,6} 7 / 4 / 0 in 30d (cold, All-Day pos 1 seventh day); {0,5,8} 12 / 3 (Eve DI 13/25/26/28, off K6). Blocked by today's midday: {4,8,9} (AZ 894), {3,5,8} (FL 538), {2,3,6} (CA 236, leg closed), {3,5,6} (KY 536).
- Cross-check on {4,6,9}: it was the 9/9 DI #1 on both boards and boxed that night — the same pattern 632 showed this morning (Mid DI #1 with six perms → boxed at CA). Two observations, not a rate; rank-1 DI is a selection basis, not an edge claim.
- No positional filter applied (ENG-MIDDAY-POS-02); no per-state targeting (ENG-PERSTATE-P0) — jurisdiction footprints above are evidence for *which set*, never for a state bet.

**Positions — PLACED (early pool, 11 draws, $2.75/unit)**

| Leg | Set | Units | Cost | If straight hits (per state) | If box-only hits (per state) |
|---|---|---|---|---|---|
| **469** | {4,6,9} | 2S | $5.50 | $450.00 | — |
| **248** | {2,4,8} | 3B | $8.25 | — | $112.50 |

**Total staked: $13.75.** Straight-only on 469 (a 469 box-order draw such as 496 or 694 pays nothing on this ticket); box-only on {2,4,8} (any order pays $112.50 per hitting state).
...
- 4-leg ticket: ~61% P(≥1 box on any leg), ~14.5% P(≥1 straight on any leg), ~39% blank session. 2-leg core (469 + 830): ~37.5% / ~7.5% / ~62.5% blank.
...
- Ride convention: 469 and 830 are day 1 tonight; 861/618 and 248 are day 1 (midday + evening on the same calendar day). A hit closes the leg; unhit legs may ride into 9/14 (Monday full boards: 33 midday / 42 evening).

### Positions — PROPOSED (every leg 2S + 3B = $48.75 on 39 draws) — total $195.00

| Combo (straight order) | Set | Provenance | Units | Cost | If straight hits (per state) | If box-only hits (per state) |
|---|---|---|---|---|---|---|
| **469** (964 / 694 swaps) | {4,6,9} | Eve pos 5 + All-Day pos 5; Eve DI #1 + All-Day DI #1 (six perms each) | 2S + 3B | $48.75 | $562.50 | $112.50 |
...
### 9/12 evening reconciliation (42 draws / 39 jurisdictions imported 3:58am ET)

| Leg | Result | Payout |
|---|---|---|
| 573 3B early-13 | 0 — {3,5,7} absent from the 13 early draws | $0 |
| 573 2S+3B full board | **BOX — NC drew 735** (late pool; bet order 573, box only) | **$112.50** |
| 573 / 248 / 895 / 395 early-13 straights (1S each) | 0 — none of the four orders landed in the early pool | $0 |

**Net: +$37.25** at the logged $75.25 stake (confirm the straight units and the 42-draw price from the ticket). **573 leg CLOSED by hit.** Boards: Eve K6 1/6 (pos 1 573), All-Day K6 1/6 (pos 3 573 — same draw), Midday K6 1/6 (pos 6 460, boxed twice at midday).

### Positions — midday only (27 draws, $6.75/unit), every leg 2S + 3B ($33.75/leg) — total $135.00

| Combo (straight order) | Set | Provenance | Units | Cost | If straight hits | If box-only hits |
|---|---|---|---|---|---|---|
| **632** (unanimous: engine + Mid DI #1 + most-drawn midday) | {2,3,6} | **Mid pos 2 + Mid DI #1 with six perms in the top 8** (632@1, 236@3, 362@4, 623@5, 263@6, 326@8 — energy 100, ds 23) — the deepest DI stack on any board today; off the All-Day/Eve K6 and DI; midday 33 in 180d (1.10×), 15 in 90d (12 Sunday-live: CO/IL/WI 2), last midday 8/21, last anywhere 9/5 evening LA 326 — clear; midday orders 632:8 / 236:6 / 362:6 / 623:6 | 2S + 3B | $33.75 | $562.50 | $112.50 |
| **706** (engine + Mid DI order; 076 most-drawn) | {0,6,7} | **Mid pos 4 + Mid DI #2 with six perms in the top 24** (706@2, 760@7, 076@9, 067@12, 607@22, 670@24), All-Day DI 14; midday **38 in 180d (1.26×), 28 in 90d — 24 Sunday-live, the widest live footprint on the board** (AZ 3, CA/CO/FL/NC/OH 2); last 9/6 evening (LA 760, WI 067), last midday 9/1 — clear; FRESH leg (the 9/10–9/12 ride expired blank; no memory in the rate); midday orders 076:11 / 760:10 / 067:6 / 670:6 / 706:2 | 2S + 3B | $33.75 | $562.50 | $112.50 |
| **618** (Mid DI best order + most-drawn midday; 681 = All-Day engine, 861 = Eve engine) | {1,6,8} | **All-Day pos 3 + Eve pos 3 — double overlap with DI presence in all three scopes** (Mid DI 10/18/19/28, All-Day DI 6/10, Eve DI 4/12); midday 37 in 180d (1.23×), 23 in 90d (18 Sunday-live: MS 3, AZ/CO/IN/NM 2); drew midday 9/8 CO 816 + 9/9 MS 168 + NJ 186 — recent, one day outside the block window (hotness is texture, anti-predictive ×3 — the cross-board depth is the basis); midday orders 618:10 / 816:9 / 168:7 / 186:5 / 681:4 | 2S + 3B | $33.75 | $562.50 | $112.50 |
| **248** (most-drawn midday + Eve DI #3 order; 824 = Mid engine order) | {2,4,8} | **Mid pos 6 + Eve pos 4** (the only Mid-board set with a second K6 slot besides {1,3,6}); Eve DI 3/5/6/10/27, All-Day DI 23, off the Mid DI top 30; midday 28 in 180d (0.93×), 17 in 90d (15 Sunday-live: CT/IL/MI/NM 2); last 9/8 evening DC 248, last midday 9/3 — clear; midday orders 248:8 / 428:5 / 824:5 / 842:5 | 2S + 3B | $33.75 | $562.50 | $112.50 |

Named swap: **316 / 136 {1,3,6}** — Mid pos 1 + All-Day pos 1 (double rank-1 for the seventh day, overdue tag both, ds 28 / 25), All-Day DI 4/22, off the Mid DI top 30; midday 29 in 180d (0.96×), 14 in 90d (10 Sunday-live), **1 in 30d** — cold on the midday stream; last anywhere 8/19 (MO 316 evening); rode 9/10–9/12 blank and expired; a fresh leg if the operator wants the rank-1 cross-reference over 248 (orders 631:8 / 361:6 / 136:5 / 316:4). Not taken: 617 {1,6,7} (Mid pos 5, Mid DI 11/15/20/30; 30/180d = 1.0×, last 9/4 — clear; orders 167:7 / 671:7); 746 {4,6,7} (Mid pos 3; 26/180d = 0.86×, 1 in 30d, off every DI top 30; orders 647/746/764 tied 6); 563 {3,5,6} (All-Day pos 2, Mid DI 13/17/21/23/27/29; 39/180d = 1.30× — highest count on the boards but drew midday 9/8 FL + 9/9 CA, one K6 slot only; orders 536:13); 694 {4,6,9} (All-Day pos 5 + Eve pos 5, All-Day DI 1/2/3/5, Eve DI 1/2 — evening-weighted, no Mid DI, 29/180d, 11 Sunday-live; carry it to the evening ticket); 830 {0,3,8} (All-Day pos 6 + Eve pos 1, 27/180d, evening-weighted); 795 {5,7,9} (All-Day pos 4, 35/180d, drew midday 9/7 IN + 9/9 NM). No double this session: every DI top-30 row in all three scopes is a single and no board pair repeats in three slots.

### Session math (uniform baseline — standing BUG-162 / SIGNAL-INFO-01 / ENG-ALLDAY-RAND-01 truth; Sunday board)

- Singles on 27 draws: ~15.0% P(≥1 box) each, ~2.7% straight (vs 18.0% / 3.2% on the 33-draw weekday board — fewer draws, lower unit cost, lower session p).
- Ticket: ~48% P(≥1 box on any leg), ~10% P(≥1 straight on any leg), ~52% blank session.
- Staked: **$135.00** (4 legs × $33.75). Expected session ≈ −$13.50 at 90% RTP. One box-only hit ($112.50) does not cover the ticket; one straight ($562.50) does.
- EV framing: all products ≈ 90% RTP; DI stacking + cross-board depth chose *which* combos, not the rate. No positional filter (ENG-MIDDAY-POS-02). Sunday footprints discounted for TN/TX/SC/AR (dark). Calibration payload = 7/24 fit — not quoted.
- Ride convention: all four legs are day 1. A midday hit closes the leg; unhit legs with an evening/All-Day slot (618 = Eve pos 3 / All-Day pos 3; 248 = Eve pos 4) may ride into the 9/13 evening ticket (Sunday evening board: TX ×2 + WV dark → ~39 draws, $9.75/unit).
...
### (A) Early-13 pool read (6:25–7:45pm block: PA SC WV ME,NH,VT TX GA TN MI MN DE OH AR DC, 13 draws → $3.25/unit) — box only

**573 {3,5,7} — still #1, by the same criteria as the 9/10 read.** Pool 19 in 180d vs 14.4 expected (1.32×, pool rank 12 of 220 and #1 among clear sets with board/DI backing), 7 in 90d, 2 in 30d, drawn in 11 of the 13 early jurisdictions (90d: DC MI OH PA SC WV); last in the pool 9/4 DC, last anywhere 9/5 — clear. **Evening DI #1 for the second day** with five perms in the top 11 (573@1, 735@3, 375@5, 537@8, 753@11, energy 100) and All-Day DI 2/7/28. **What changed since last night:** (1) it is OFF both K6 boards today (9/10 it sat Eve pos 4 + All-Day pos 5; today it is DI-only), and (2) it blanked in 12 of the 13 early draws last night (DE unresolved). Neither moves the data: the pool count is unchanged (nothing in the pool drew it since 9/4) and the 9/10 read was session-only, no carry. Orders unchanged: 375:11 / 537:10 / 753:9 / 573:9 / 357:8 / 735:7 — 573 = evening DI best order, 375 = most-drawn.

Board-backed alternatives if the operator wants a K6 set in the pool instead: **670/706 {0,6,7}** (Eve pos 1; pool 17 with **11 in 90d — the strongest recent pool presence of any board set**, 10 of 13 jurisdictions, last pool 8/25, last anywhere 9/6 — clear; ride day 2) and **691/196 {1,6,9}** (Eve pos 3; pool 17, **4 in 30d — the most recent**, last pool 9/7 — clear). {1,5,8} is weak in the pool (11, 5 jurisdictions) despite its full-board strength below.

Uniform truth: any single set is ~7.5% to box across 13 draws (~1.3% straight); the pool count and DI stacking pick *which* set, not the rate. Staked if placed at 3B: $9.75 (+$3.25 with a straight unit) → box pays $112.50 (straight $225).

### (B) #1 pick for the FULL evening session (~42 draws, ~$10.50/unit)

| Rank | Combo (straight order) | Set | Why |
|---|---|---|---|
| **#1** | **185** (All-Day engine order + most-drawn evening order); **158** = evening engine order | {1,5,8} | **Triple overlap still standing — Eve pos 6 / All-Day pos 5 / Mid pos 4** (the other triple, {0,6,7}, also stands); **Eve DI 4** (158) + 13/25, **All-Day DI 3** (185) + 18, six perms in the Mid DI top 25; evening **47 in 180d vs 38.6 expected (1.22×)**, 26 in 90d, **9 in 30d — the most 30-day evening draws of any board set**; last drawn 9/7 (ID 815, evening) — clear; 90d pool jurisdictions AR DC GA OH (pool-weak, so this is the full-board pick, not the early read); evening orders 185:11 / 815:9 / 581:9 / 518:8 / 851:5 / 158:5. Day 1 leg from the midday ticket, unhit → evening carry. |
| #2 | **670** (evening engine order); **706** = most-drawn evening order + All-Day/Mid engine order | {0,6,7} | **Eve pos 1** + All-Day pos 3 + Mid pos 6 (triple overlap, seventh in the log); DI in all three scopes (Eve 10/14/19/28, All-Day 5/20, Mid 3); evening 39 in 180d (1.01× — at expectation), 19 in 90d, 6 in 30d; last 9/6 WI 067 — clear; orders 706:11 / 067:9 / 760:6 / 076:5 / 670:5 / 607:3. **Ride day 2 blank twice today and yesterday — 9/12 is its last ride day.** Stronger early-pool presence than #1 (11 of its 17 pool draws in 90d). |
| #3 | **573** / 375 | {3,5,7} | The count leader — evening 54 in 180d vs 38.6 (1.40×, z ≈ +2.5), 29 in 90d, 8 in 30d — and evening DI #1, but on NO K6 board today; the early-13 pick above, not a board leg. |
...
**Universe re-check ~8:35pm (operator: "not betting board picks, only these 2 operator picks — deep think"):** scanned all 220 sets on the late pool, clear-of-9/9–9/11 only (39 clear singles). By mean z over 180/90d: **248 (43 late in 180d, z +3.8; 18 in 30d, z +6.4 — 20 evening draws in 30d across 17 jurisdictions, no duplicate rows, last 9/8 DC)**, 389 (35 / 25 in 90d / 3 in 30d, ds 269), 569 (35 / 23 / 9, ds 76), then **357 (35 / 22 / 6, the only top-4 set with DI backing: Eve 1/3/5, All-Day 2/7)**; 349 is 7th (30 / 13 / 5, Eve DI 2/7/22). **Persistence test on this pool** (top-20 sets by prior-180d late count → realised next-30d late count, 5 monthly cutoffs 4/14–8/12): 1.03× / 0.97× / 1.16× / 0.90× / 1.15× — mean ≈1.04×, i.e. hot late-pool counts do NOT persist; consistent with STATE_STR ×3 and SIGNAL-INFO-01. Ruling: **#1 573/375 and #2 934/943 stand** (DI-backed + positive count); 248 recorded as the named swap for #2 — the largest count anomaly in the universe, but pure recent hotness, no engine support, and the persistence test says it carries no forward rate. Straight orders: DI order vs most-drawn order measured equivalent (≈22.5% vs ≈21% straight-given-box, within noise) — one order per set, no perm splits.
...
Slate basis: 9/11 K6 (workflow run 5:53am ET, engine v2.1, edge v53). All-Day K6 = 136 / 590 / 706 / 490 / 185 / 460; Midday K6 = 316 / 825 / 054 / 518 / 783 / 706; Evening K6 = 670 / 754 / 196 / 142 / 934 / 158. All 18 slots are singles and every DI top-30 row in all three scopes is a single, so the double is again sourced from the board's pair structure. 9/10 evening (41 draws imported 5:52am ET — **DE evening row missing**, 38 jurisdictions): 936 {3,6,9} boxed at FL (369); 573 / 706 / 447 and the early-13 573 read all blank; Eve K6 went 1/6 (936), All-Day 1/6 (the midday 275), Midday 0/6. Cross-scope today: **two triple overlaps on the same boards** — **{0,6,7} = All-Day pos 3 / Mid pos 6 / Eve pos 1** (seventh triple overlap; Eve overdue tag; Mid DI 3 with six perms in the top 14) and **{1,5,8} = All-Day pos 5 / Mid pos 4 / Eve pos 6** (first time the log has two on one day; six perms in the Mid DI top 25, All-Day DI 3, Eve DI 4); **{1,3,6} = All-Day pos 1 + Mid pos 1** (double rank-1 for the sixth day, overdue tag both, ds 23 / 26). Nothing else is shared across K6 boards. 3-day block scan (9/8–9/10, all sessions): **every set on all three K6 boards is clear**; the closest calls are {0,4,9}, {1,5,8}, {0,4,6}, {2,5,8}, {0,4,5} (all last drew 9/7, one day outside the window). Rides in: 136 and 706 from the 9/10 midday ticket (day 2, calendar count); 764 {4,6,7} is day 2 eligible but off every board today (not carried); 573 / 447 are day 2 only if the 9/10 evening board was placed. Closed by hit: {1,5,9} and {5,5,7} (9/10 midday), {3,6,9} (9/10 evening, if placed). Midday base: 4,948 midday draws in 180d → a single set expects 29.7, a double 14.8; 966 in 30d → 5.8 / 2.9.

### Positions — midday only (33 draws, $8.25/unit), every leg 2S + 3B ($41.25/leg) — total $165.00

| Combo (straight order) | Set | Provenance | Units | Cost | If straight hits | If box-only hits |
|---|---|---|---|---|---|---|
| **706** (ride day 2; 670 = evening engine order, 076 most-drawn) | {0,6,7} | **Triple overlap — All-Day pos 3 / Mid pos 6 / Eve pos 1** (overdue tag on the evening board), **Mid DI 3** with six perms in the top 14 (706@3, 760@8, 076@9, 067@10, 670@13, 607@14 — energy 100), All-Day DI 5/20, Eve DI 10/14/19/28; unhit 9/10 midday (day 1); midday **38 in 180d vs 29.7 expected (1.28×)**, 29 in 90d, 10 in 30d (hotness is texture, not the selection reason — STATE_STR anti-predictive ×3); last drawn 9/6 (evening, WI 067) / 9/1 (midday) — clear; 90d midday footprint 29 draws / 19 jurisdictions (AZ:3 CO:3 TN:3 CA/FL/NC/OH:2); midday orders 076:11 / 760:10 / 067:6 / 670:6 / 607:3 / 706:2 — 706 = engine + DI best order in both the All-Day and Midday scopes | 2S + 3B | $41.25 | $562.50 | $112.50 |
| **518** (185 = All-Day engine order, 158 = evening engine order; 158/185 tied most-drawn) | {1,5,8} | **Triple overlap — All-Day pos 5 / Mid pos 4 / Eve pos 6**; six perms in the Mid DI top 25 (518@12, 158@16, 185@18, 581@19, 815@21, 851@25), **All-Day DI 3** (185) + 18, **Eve DI 4** (158) + 13/25; midday 35 in 180d (1.18×), 26 in 90d, 5 in 30d; last drawn 9/7 (evening, ID 815) / 8/30 (midday) — clear; 90d midday footprint 26 draws / 18 jurisdictions (PA:3 VA:3 CT/NM/TX/WI:2); midday orders 158:9 / 185:9 / 518:5 / 581:5 / 851:5 / 815:2 — 518 = Midday engine order; take 185 for the All-Day order or 158 for the most-drawn tie | 2S + 3B | $41.25 | $562.50 | $112.50 |
| **136** (ride day 2; 316 = Midday engine order, 631 most-drawn) | {1,3,6} | **All-Day pos 1 + Mid pos 1** — double rank-1 for the sixth day, overdue tag both scopes; All-Day DI 1/12/19; Mid DI 31 (first row below the top 30, on-slate); unhit 9/10 midday (day 1); midday 29 in 180d (0.98×), 15 in 90d, **1 in 30d** (WI 8/16) — cold on the midday stream (overdue measured flat; the cross-reference is the basis, not the gap); last drawn anywhere 8/19 (MO 316 evening, 23 days) — clear; 90d midday footprint 15 / 14 jurisdictions (TN:2); midday orders 631:8 / 361:6 / 136:5 / 316:4 / 163:3 / 613:3 — 136 = All-Day engine + DI best order. **Swap for 460 (below) if you would rather not carry the cold ride** | 2S + 3B | $41.25 | $562.50 | $112.50 |
| **004** (double; 400 second) | {0,0,4} | Not on any board; built from the **{0,4} pair that sits in three board slots** (490 All-Day pos 4, 460 All-Day pos 6, 054 Mid pos 3) with digit 0 in four of six All-Day sets (590, 706, 490, 460); **midday 21 in 180d vs 14.8 expected (1.42×, z +1.6 — tied-highest within-class among unblocked doubles with a board pair, with 466)**, 7 in 90d, 2 in 30d; last drawn 9/5 (evening, IA 400) / 8/15 (midday) — clear of the 9/8–9/10 window; midday orders **004:9** / 400:8 / 040:4; doubles are 3-of-1000 per draw, so ~half a single's box rate at ~double the box payout | 2S + 3B | $41.25 | $675.00 | $225.00 |

Alternates (not placed): **460 {0,4,6}** (All-Day pos 6 and the only other set with DI presence in all three scopes — All-Day DI 4/14, Mid DI 23, Eve DI 27; midday 32/180d = 1.08×, 21 in 90d, 5 in 30d, last 9/7 midday TN 460 — clear; footprint 21 / 15 (TN:4 DE/FL/NM:2); orders **460:9** / 604:6 / 640:5 — 460 = engine order and most-drawn) is the swap for 136, and the fourth single if the operator wants 4S + 0D ($165.00 either way). **490 {0,4,9}** (All-Day pos 4, All-Day DI 8/13/15, Eve DI 20/24; 29/180d, 16 in 90d, 5 in 30d, last 9/7 evening NJ 049 / midday 9/2; footprint 16 / 11 (TX:4 FL/ID:2); orders **490:9** / 940:6 / 094:5). **590 {0,5,9}** (All-Day pos 2, All-Day DI 6, Eve DI 26/30; 31/180d, 21 in 90d, 8 in 30d, last 9/2 both sessions; footprint 21 / 18; orders 950:8 / 590:7 / 095:6). **573 {3,5,7}** (All-Day DI 2/7/28, **Eve DI 1** again with five perms in the top 11, Mid DI 28; off every K6 board today; ride day 2 only if the 9/10 evening board was placed; midday 28/180d, 18 in 90d, 5 in 30d, last 9/5 midday TX 735 — clear; orders 537:9 / 753:6 / 573:4). **Ride 764 {4,6,7}** (day 2 from 9/10 midday; All-Day DI 9/10, Eve DI 23, off every K6; 26/180d, 17 in 90d, 1 in 30d, last 9/4 evening; orders 647 / 746 / 764 tied at 6) — not carried. **Mid DI #1 {2,3,6}** (six perms at ranks 1–2–4–7, ds 21, off every K6; 33/180d, 16 in 90d, 3 in 30d, last 9/5 evening LA 326 — clear; orders **632:8** / 236:6 / 362:6 / 623:6) is the midday-DI-only alternate. Midday-board-only sets not carried (the lean): {2,5,8} (Mid pos 2 / DI 32; 21/180d = 0.71×, last 9/7 evening FL 825), {0,4,5} (Mid pos 3 / DI 33; 28/180d, last 9/7 evening DC 045 — its {0,4} pair feeds the double), {3,7,8} (Mid pos 5 / DI 34; 36/180d = 1.21×, 6 in 30d, last 9/6 evening GA 783; orders 873:8 / 378:6 / 738:6 / 783:6). Doubles: **466/646 {4,6,6}** (21/180d, z +1.6 — ties 004; 13 in 90d, 6 in 30d, last 9/7 midday KS 466 — clear; {4,6} pair in 460 only; orders 646:8 / 466:7 / 664:6) is the hotter alternate, 004 takes it on structure (three slots vs one); **006 {0,0,6}** ({0,6} pair also in three slots — 706 ×2 + 460; 17/180d = 1.15×, 8 in 90d, 2 in 30d, last 8/30 evening AZ 060; orders 006:9 / 060:5 / 600:3); **599/995 {5,9,9}** (19/180d, 11 in 90d, 6 in 30d, {5,9} pair in 590, last 9/7 midday TX 959; orders 995:8 / 959:7 / 599:4); **446/464 {4,4,6}** (19/180d, 7 in 30d, last 9/3 evening; orders 464:7 / 446:6 / 644:6); **115/511 {1,1,5}** (16/180d, {1,5} pair in 518/185, last 9/6 evening IN 511; orders 511:7 / 115:5); **337 {3,3,7}** (19/180d, {3,7} pair in 783, last 9/6 evening; orders 733:7 / 337:6 / 373:6). Doubles with a board pair ruled out by the 3-day window: 044 (9/9), 005 (DC 005 9/10), 055 (9/9), 009 (9/8), 558 (9/9), 588 (9/9), 118 (DC 118 9/10), 155 (9/9), 116 (9/10), 166 (9/9), 336 (9/8), 366 (9/8), 133 (9/9), 449 (9/10), 559 (9/10), 667 (TX 766 9/10), 377 (9/9), 338 (9/10), 778 (9/10), 255 (9/10), 445 (9/10), 455 (9/9).

### Session math (uniform baseline — standing BUG-162 / SIGNAL-INFO-01 / ENG-ALLDAY-RAND-01 truth)

- Singles: ~18.0% P(≥1 box) each on 33 draws, ~3.2% straight. Double 004: ~9.4% box / ~3.2% straight; book pays the 3-way box at $75/unit — confirm before sizing.
- Ticket: ~50% P(≥1 box on any leg), ~12% P(≥1 straight on any leg), ~50% blank session.
- Staked: **$165.00** (4 legs × $41.25). Expected session ≈ −$16.50 at 90% RTP. A single box-only hit ($112.50) does not cover the ticket; a single straight ($562.50), or the double boxing ($225.00) on its own, does.
- EV framing: all products ≈ 90% RTP; selection chose *which* combos, not the rate. No positional filter (ENG-MIDDAY-POS-02). Calibration payload = 7/24 fit (9/1 refit failed its gate) — not quoted. Cross-scope overlap is texture, not a measured edge; yesterday's hits (195 ×2 box, 575 straight) do not move today's rate.
- Ride convention: 706 and 136 are day 2; 518 and 004 are day 1. A midday hit closes the leg; unhit All-Day-board legs may ride into 9/11 evening on the evening ticket (706 sits Eve pos 1, 518/158 Eve pos 6).

### Resolution (midday imported 2026-09-11 ~4:35pm ET from the operator's tablet paste — 33 draws / 31 jurisdictions, import e9e4d3ad; MD + PR skipped by convention; hit detection ran: 2 board matches; verified vs histories 2026-09-11 midday)

| Leg | Result | Payout |
|---|---|---|
| 706 (2S+3B) | 0 — {0,6,7} absent from all 33 midday draws (closest: ON 608 {0,6,8}, GA 676 {6,6,7}); ride day 2 blank → 9/12 is the LAST ride day | $0 |
| 518 (2S+3B) | 0 — {1,5,8} absent (closest: NJ 810 {0,1,8}, IA 758 {5,7,8}); day 1 blank → carries to the evening ticket (Eve pos 6) | $0 |
| 136 (2S+3B) | 0 — {1,3,6} absent (MS 336 is {3,3,6}); ride day 2 blank → 9/12 last ride day | $0 |
| 004 double (2S+3B) | 0 — {0,0,4} absent (PA 003 is {0,0,3}) | $0 |

**Net: −$165.00** if placed as proposed. The boards' own midday matches were elsewhere: **All-Day pos 2 590 boxed at ME,NH,VT (059)** and **Midday pos 5 783 boxed at CO (837)** — neither was a ticket leg (590 was named only as an alternate). Alternates 460 / 490 also blank. 3-day block after import (9/9–9/11, all sessions): {0,5,9} and {1,2,4} drew today (ME,NH,VT 059 → All-Day pos 2 CLOSED; CA 142 → Eve pos 4 {1,2,4} closed by the same-day convention); {1,2,8} drew three times in the window (not a candidate); {1,5,9} closed 9/10. **⚠ DE 9/10 evening row is STILL missing** (41 rows, 0 DE) — the 9/10 early-13 573 read remains unresolved on that one draw.
...
### Early-13 pool pick — box only

| Combo (straight order) | Set | Provenance | Units | Cost | If straight hits | If box-only hits |
|---|---|---|---|---|---|---|
| **573** (375 = All-Day order and most-drawn) | {3,5,7} | **Eve pos 4 + All-Day pos 5**; **evening DI #1** with five perms in the top 9 (573@1, 735@2, 375@3, 537@5, 753@9, energy 100) and **All-Day DI #2** (573@2, 375@8) — the most-stacked set on tonight's boards; early-13 pool evening draws **19 in 180d vs 14.3 expected** (1.33×), 7 in 90d, 2 in 30d, drawn in **11 of 13 early jurisdictions** (90d: DC MI OH PA SC WV) — pool rank 12 of 220 and #1 among clear board sets; full evening 54 in 180d vs 38.4 expected (1.41×), 29 in 90d, 8 in 30d (hotness is texture, not the selection reason); last drawn anywhere 9/5, last in the pool 9/4 DC — clear; evening orders 375:11 / 537:10 / 753:9 / 573:9 / 357:8 / 735:7 (flat) — 573 = evening engine + evening DI best order | 3B (+ optional 1S) | $9.75 box (+ $3.25 straight) | $225.00 | $112.50 |

Runner-up (not placed): **936 {3,6,9}** — Eve pos 3, six perms in the evening DI top 15 (936@4, 396@6, 639@7), pool 18/180d with 11 in 90d (stronger recent pool presence, footprint 8 of 13 in 90d), last 9/6 — clear; orders 963/639/396/369 tied at 8, 936:4. Third: **706 {0,6,7}** triple overlap, ride day 2, pool 17/180d (rank 28). 3-day-blocked: {1,5,9}, {2,5,7}.

### Session math (uniform baseline — standing BUG-162 / SIGNAL-INFO-01 truth)

- One set across 13 draws: ~7.5% P(box), ~1.3% P(straight). Staked $9.75 at 3B ($13.00 with the straight unit). Expected ≈ −$1 at 90% RTP. The pool count and board stacking chose *which* set, not the rate.
- Ride convention: this is a session-only early-pool read, not a ride leg. Unhit → no carry unless the operator names it on a later ticket.

### Resolution (evening imported 2026-09-11 5:52am ET — 41 draws / 38 jurisdictions; **DE evening row missing from the import**, so the pool ran 12 of its 13 draws in the data; verified vs histories 2026-09-10 evening, early-13 jurisdictions only)

| Leg | Result | Payout |
|---|---|---|
| 573 (3B) | 0 — {3,5,7} absent from all 12 imported early-pool draws (PA 128, SC 286, WV 065, ME,NH,VT 370, TX 425/184, GA 010/804, TN 422, MI 229, MN 669, OH 749, AR 685, DC 118/232); DE unresolved until its row is imported | $0 |

**Net: −$9.75** if placed at 3B (−$13.00 with the straight unit). Session-only read — no carry.
...
### Resolution — full board (evening imported 2026-09-11 5:52am ET, 41 draws / 38 jurisdictions — DE evening row missing; verified vs histories 2026-09-10 evening) — applies only if placed

| Leg | Result | Payout |
|---|---|---|
| 573 (2S+3B) | 0 — {3,5,7} absent from all 41 imported evening draws | $0 |
| 936 (2S+3B) | **BOX** — FL 369 (engine order 936 not straight) | $112.50 box-only |
| 706 (2S+3B) | 0 — {0,6,7} absent from all 41 imported evening draws | $0 |
| 447 double (2S+3B) | 0 — {4,4,7} absent from all 41 imported evening draws | $0 |

**Net: −$97.50** at the proposed $210.00 stake if placed ($112.50 returned). If placed: 936 CLOSED by hit; 573 / 447 → ride day 2 eligible, 706 → day 2 under calendar count (its 9/10 midday and evening legs share the day). Eve K6 went 1/6 (936 boxed); All-Day K6 1/6 (SC 275 at midday); Midday K6 0/6. The closed-by-convention Eve pos 1 {1,5,9} did not draw in the evening — the convention cost nothing tonight.
...
### Resolution (midday imported 4:35pm ET, 33 draws; verified vs histories 2026-09-10 midday)

| Leg | Result | Payout |
|---|---|---|
| 136 (2S+3B) | 0 — {1,3,6} absent from all 33 midday draws | $0 |
| 706 (2S+3B) | 0 — {0,6,7} absent from all 33 midday draws | $0 |
| 764 (2S+3B) | 0 — {4,6,7} absent from all 33 midday draws | $0 |
| 195 (2S+3B) | **BOX ×2** — KY 591, ME,NH,VT 951 (straight at Tri-State if the 951 order was placed) | $225.00 box-only ($675.00 if 951 straight + KY box) |
| 575 double (2S+3B) | **STRAIGHT** — IA 575 | $675.00 |

Settle at 2S + 3B per leg per hitting state: single straight $562.50 / box-only $112.50; double straight $675.00 / box-only $225.00.

**Net: +$693.75** at the proposed $206.25 stake if 195 was placed in the 195 order ($900 returned: 575 straight $675 + 195 box ×2 $225); **+$1,143.75** if the 951 order was placed (Tri-State 951 straight $562.50 + KY box $112.50 + 575 straight $675 = $1,350). Confirm the placed order and units from the ticket. **195 and 575 legs CLOSED by hit** (convention; 195 was on its last ride day regardless). 136 / 706 / 764 unhit → ride day 2 eligible into 9/10 evening. Second positive session in the log.
...
| Combo (straight order) | Set | Provenance | Units | Cost | If straight hits | If box-only hits |
|---|---|---|---|---|---|---|
| **385** | {3,5,8} | **Eve pos 1 + All-Day pos 2** (All-Day DI 5, Eve DI 6/17/24); evening 37 in 180d (at the 37.9 expected), 23 in 90d, **9 in 30d**; last drawn anywhere 8/26 (13 evening days, overdue tag — overdue measured flat, the cross-reference is the basis); 90d evening footprint 23 draws / 17 jurisdictions (MN, MS, NC, SC, TN, WV ×2 — SC/TN/WV in the early-13 pool); evening orders **385:11** / 358:7 / 538:6 / 835:5 — 385 = engine best order in BOTH scopes and the most-drawn order | 2S + 3B | $52.50 | $562.50 | $112.50 |
| **637** (ride day 2; 736 = All-Day order) | {3,6,7} | **Triple overlap** (Mid pos 6 / All-Day pos 6 / Eve pos 5) and **evening DI #1** (5 perms in the DI top-8, energy 100), All-Day DI 3; unhit midday (3 brushes); evening 39 in 180d (1.03×), 21 in 90d, 6 in 30d; last drawn 9/4 TN midday — clear; 90d footprint 21 (AR ×3, ID/MI/NE/WV ×2); evening orders 736:9 / **637:8** / 367:6 / 673:6 / 763:6 — 637 = evening engine best order, 736 = All-Day order and most-drawn evening order | 2S + 3B | $52.50 | $562.50 | $112.50 |
| **195** | {1,5,9} | All-Day pos 3 (All-Day DI 6/7/15 — three perms in the top 15) and sat Eve pos 4 yesterday (Eve DI 14 today); evening 40 in 180d (1.06×), 26 in 90d, 9 in 30d; last drawn 9/2 (ON evening) — clear; 90d footprint 26 draws / 21 jurisdictions (ON ×3, DC/MS/QC ×2 — DC in the early-13 pool); evening orders **951:13** / 591:9 / 195:6 / 519:4 — 195 = All-Day engine order, 519 = evening DI best order, 951 the most-drawn by a wide margin (take 951 if you want the order skew) | 2S + 3B | $52.50 | $562.50 | $112.50 |
| **335** (double) | {3,3,5} | Not on any board; built from the {3,5} pair that anchors leg 1 (385, Eve pos 1 / All-Day pos 2) and the closed {3,5,6}; **evening 33 in 180d vs 18.9 expected (z +3.2 — highest within-class among unblocked doubles**; it was the named-but-blocked alternate on 9/7, its 9/4 draw is now outside the window), 24 in 90d, 7 in 30d; last drawn 9/4 evening — clear; 90d footprint 24 (NM ×3, CT/NJ/OH/TX/VA ×2); evening orders **335:13** / 353:12 / 533:8 | 2S + 3B | $52.50 | $675.00 | $225.00 |

Alternates (not placed): **571 {1,5,7}** (All-Day pos 5, All-Day DI 8, no evening DI presence; evening 45/180d = 1.19×, hottest of the six All-Day sets, 10 in 30d, last 9/4 — hotness is not a selection reason (STATE_STR anti-predictive ×3), so it yields to 195's higher board slot + evening DI presence) in place of 195; **136 {1,3,6}** (Mid pos 1 + All-Day pos 1, All-Day DI 1; ride exhausted under session counting, one more evening allowed under calendar counting; evening 28/180d = 0.74×, 2 in 30d, last 8/19 — cold on this session; orders 613:8 / 361:7 / 136:4) if the operator would rather carry the double rank-1 than take 195; doubles **177 {1,7,7}** (32/180d, z +3.0, 7 in 30d, last 9/4; {1,7} pair in 571 + 417; orders 771:12 / 177:12), **585 {5,5,8}** (ride day 2 from 9/7 evening; {5,8} pair in 385; 23/180d, last 8/27; orders 585:12 / 558:8), **117 {1,1,7}** (ride from 9/8 midday; evening 15/180d = 0.79×, cold on this session; orders 711:9 / 117:4). Doubles ruled out by the 3-day window: 115 (9/6, z +2.8), 447 (9/6), 033 (9/7), 099 (9/5), 133 (9/5), 336 (9/6), 337 (9/6), 229 (9/7), 225 (9/7), 557 (9/6), 116 (DC 611 today), 366 (NJ 663 today), 556 (NY 655 today), 449 (SC 494 today), 244 (TX 244 today), 266 (AR 626 today).

### Early-13 pool read (asked ~5pm ET: one box-only combo for the 6:25–7:45pm block — PA SC WV ME,NH,VT TX GA TN MI MN DE OH AR DC, $3.25/unit)

**195 {1,5,9} box.** Among sets clear of the 3-day window it is #1 in the early-13 pool: 20 early-pool evening draws in 180d vs 14.1 expected (z ≈ +1.6), 10 in 90d, 4 in 30d, and it has drawn in 12 of the 13 early jurisdictions (all but WV) — the widest early footprint of any candidate. Already leg 3 above (All-Day pos 3). Runner-up 385 {3,5,8}: 14/180d in the pool (at expectation) but 13 of those in the last 90d, footprint 10 of 13. Uniform truth: any single set is ~7.5% to box across 13 draws; the pool count picks which set, not the rate.
...
### Resolution (results imported by the 9/9 workflow 8:57am ET; verified vs histories 2026-09-08 session=evening — board ran 42 evening draws / 39 jurisdictions, as priced)

| Leg | Result | Payout |
|---|---|---|
| 385 (2S+3B) | 0 — {3,5,8} absent from all 42 evening draws; brushes GA 850, GA 503, TN 553, QC 958, MI 532, WI 253 | $0 |
| 637 (2S+3B) | **BOX — NC drew 376** (bet order 637, so box only) | **$112.50** (3B × $37.50) |
| 195 (2S+3B) | 0 — {1,5,9} absent; brushes TX 179, MO 919, KS 561, FL 695, QC 958, AZ 594 | $0 |
| 335 double (2S+3B) | 0 — {3,3,5} absent; TN 553 was {3,5,5}, a brush not a hit; NJ 363 brushed the 3/3 pair | $0 |

**1/4 legs boxed, no straight. Returned $112.50 on $210.00 staked → net −$97.50.** **637/{3,6,7} CLOSED by hit** on ride day 2 (the triple overlap landed on the evening half; now inside the 3-day post-hit block). 385 and 195 unhit → ride day 2 on 9/9 (both re-selected at the top of the 9/9 All-Day and Evening boards — below). 335 unhit, day 2 available as a double alternate only.

Boards: Evening K6 **3/6** on the evening half (pos 5 637 boxed NC 376; pos 6 146 boxed SC 146; pos 2 417 boxed NM 417). All-Day K6 **2/6** for the day (563 midday FL 365, 736 evening NC 376). Ordinary variance at the ~59% any-box pre-placement price.

## 2026-09-09 — ALL-DAY ride (Wednesday: 33 midday + 42 evening = 75 draws → $18.75/unit per leg per bet type) — PROPOSED 2 singles, both day-2 rides; confirm placement + units from the ticket

Slate basis: 9/9 K6 (workflow run 8:57am ET, engine v2.1, edge v53). All-Day K6 = 385 / 195 / 571 / 485 / 573 / 469; Evening K6 = 385 / 469 / 195 / 105 / 573 / 458; Midday K6 = 632 / 746 / 617 / 458 / 571 / 317. Cross-scope: **{3,5,8} = All-Day pos 1 + Eve pos 1 (double rank-1, overdue tag, ds 14)**; **{1,5,9} = All-Day pos 2 + Eve pos 3**; {4,5,8} on ALL THREE boards (All-Day pos 4 / Eve pos 6 / Mid pos 4 — fifth triple overlap); {3,5,7} All-Day pos 5 + Eve pos 5 (Eve DI #2); {4,6,9} All-Day pos 6 + Eve pos 2 (DI #1 in both scopes, energy 100); {1,5,7} All-Day pos 3 + Mid pos 5. 3-day block scan (9/6–9/8, all sessions): every board set is clear — the closest are {4,5,8} / {3,5,7} / {4,6,9}, all last drawn 9/5 (window opens today). Operator asked for exactly 2 singles to ride every draw today.

### Positions — full day, both sessions (75 draws, $18.75/unit), every leg 2S + 3B ($93.75/leg) — total $187.50 (midday half $41.25/leg, evening half $52.50/leg)

| Combo (straight order) | Set | Provenance | Units | Cost | If straight hits | If box-only hits |
|---|---|---|---|---|---|---|
| **385** (ride day 2) | {3,5,8} | **All-Day pos 1 + Eve pos 1** — the only double rank-1 on the day; All-Day DI 7, Eve DI 6/17/27; 58 in 180d all sessions (0.87× the ~67 expected), evening 37 (at expectation, 9 in 30d), midday 21 (0.72×, 1 in 30d — cold on the midday half); last drawn anywhere 8/26 (NC 385 + WV 835, both evening) — 14 evening days, overdue tag (overdue measured flat; the cross-reference is the basis); 90d footprint evening 23 draws / 17 jurisdictions, midday 8 / 8; orders **385:15** (11 evening) / 835:10 / 853:10 / 358:8 / 583:8 / 538:7 — 385 = engine best order in BOTH scopes and the most-drawn order | 2S + 3B | $93.75 | $562.50 | $112.50 |
| **195** (ride day 2; 951 if you want the order skew) | {1,5,9} | **All-Day pos 2 + Eve pos 3**; All-Day DI 9/10/20/26 (four perms in the top 30), Eve DI 15; 73 in 180d (1.09×), midday 33 (1.13×, 4 in 30d), evening 40 (1.06×, 9 in 30d); last drawn 9/2 (ME,NH,VT 591 evening) — clear; **widest footprint of any candidate**: 90d evening 25 draws / 20 jurisdictions, midday 22 / 14; orders **951:21** / 591:14 / 195:12 / 915:11 / 159:8 / 519:7 — 195 = All-Day engine order (the scope that governs an all-day ride), 519 = evening DI best order (least drawn), 951 the most-drawn by a wide margin | 2S + 3B | $93.75 | $562.50 | $112.50 |

Alternates (not placed): **458/485 {4,5,8}** (all three boards but lower slots — All-Day pos 4 / Eve pos 6 / Mid pos 4; midday DI 7 with five perms in the midday top 19; 72/180d, 13 in 30d; last 9/5 DC 485 — first day out of the block; orders 854:17 / 845:12 / 458:12 / 485:12; engine order differs by scope — 485 All-Day, 458 Mid, 548 Eve) is the swap for 195 if the operator wants a midday-board anchor on the midday half; **469/694 {4,6,9}** (All-Day pos 6 + Eve pos 2, DI #1 in both scopes with four perms in the All-Day top 4; 73/180d; last 9/5; orders 469:17 / 496:13 / 649:13; engine 694 All-Day / 964 Eve) is the fresh-leg alternate on signal strength alone; **573 {3,5,7}** (All-Day pos 5 + Eve pos 5, Eve DI #2; 82/180d = 1.22×, hottest of the six — hotness is not a selection reason, STATE_STR anti-predictive ×3). Neither ride was displaced: both re-selected at the top of the All-Day board, and no candidate carries a measured edge over them (everything sits at the uniform rate).

### Session math (uniform baseline — standing BUG-162 / SIGNAL-INFO-01 / ENG-ALLDAY-RAND-01 truth)

- Per leg on 75 draws: ~36.3% P(≥1 box), ~7.2% P(≥1 straight). Midday half alone ~18%, evening half alone ~22%.
- Both legs: ~59.5% P(≥1 box on either), ~13.9% P(≥1 straight on either), ~40.5% blank day.
- Staked: **$187.50** (2 legs × $93.75) if both halves are placed up front. Expected day ≈ −$19 at 90% RTP. One box-only hit ($112.50) does not cover the ticket; any straight ($562.50) or two boxes do.
- Placement mechanics: place the midday half now ($41.25/leg); after the ~4:35pm midday import, re-up only the UNHIT legs for the evening half ($52.50/leg) — a midday hit closes that leg by convention and the evening half of it is not placed.
...
### Resolution (results imported ~4:35pm ET; verified vs histories 2026-09-08 session=midday — board ran 33 midday draws, as priced)

| Leg | Result | Payout |
|---|---|---|
| 617 (2S+3B) | 0 — {1,6,7} absent from all 33 midday draws; 5 two-digit brushes (CO 816, DC 611, IA 061, ID 679, IL 178) | $0 |
| 367 (2S+3B) | 0 — {3,6,7} absent; 3 brushes (FL 365, NJ 663, ID 679) | $0 |
| 635 (2S+3B) | **BOX — FL drew 365** (bet order 635, so box only) | **$112.50** (3B × $37.50) |
| 316 (2S+3B) | 0 — {1,3,6} absent; 6 brushes (GA 318, CO 816, IA 061, DC 611, FL 365, NJ 663) — the 1/6 and 3/6 pairs drew all over the board, the set never completed | $0 |
| 117 double (2S+3B) | 0 — {1,1,7} absent; DC 611 was {1,1,6}, a brush not a hit; IL 178 brushed the 1/7 pair | $0 |

**1/5 legs boxed, no straight. Returned $112.50 on $206.25 staked → net −$93.75** (if placed as proposed — settle units from the ticket). **635/{3,5,6} CLOSED by hit** on its last ride session (also now inside the 3-day post-hit block). 617, 367, 316 and 117 unhit: 367 rides into 9/8 evening (it is Eve pos 5 / All-Day pos 6 — below); 617 has no evening or All-Day board cross-reference and is dropped; 316/{1,3,6} has exhausted the 3-session ride (9/7 mid, 9/7 eve, 9/8 mid) and is carried only as a named alternate under calendar counting; 117 is named as a double alternate.

Boards: Midday K6 **1/6** — pos 4 635 boxed (FL 365). All-Day K6 **1/6 on the midday half** — pos 4 563 boxed (same FL 365). Evening K6 pending tonight's draws; **Eve pos 3 106/{0,1,6} drew midday (IA 061)** → closed by convention for tonight. Digit texture: 6 hottest (15 of 33 draws), then 4 (14), 8 and 9 (12 each); 0 coldest (6). Ordinary variance at the ~59% any-box pre-placement price.

**Closed-by-convention tonight (not re-bettable):** {3,5,6} (operator leg + All-Day pos 4 + Mid pos 4) and {0,1,6} (Eve pos 3). Everything else on the three boards is clear of the 3-day window (no board set drew 9/5–9/7).
