...
<p class="sub">HitMaster ZK6 · Daily Intelligence · engine v2.1 · slates regenerated 12:30 UTC on fresh box+pair coverage</p>
...
<div class="sec">
  ...
  <table>
    ...
    <tr class="t1"><td><b>T1 · Standout×Conv</b></td><td class="mono">059</td><td>eve #1 · allday #5</td><td><b>10</b></td><td>allday <b>15.7%</b> · eve 9.2%</td></tr>
    <tr class="t1"><td><b>T1 · Standout×Conv</b></td><td class="mono">047</td><td>eve #5 · midday #5</td><td><b>10</b></td><td>eve 6.4% · mid 1.7%</td></tr>
    <tr class="t1"><td>T1 · Standout</td><td class="mono">236</td><td>midday #6</td><td><b>19</b> ◀ top</td><td>3.1%</td></tr>
    <tr class="t1"><td>T1 · Standout</td><td class="mono">458</td><td>allday #4</td><td>15</td><td>4.3%</td></tr>
    <tr class="t1"><td>T1 · Standout</td><td class="mono">016</td><td>allday #6</td><td>12</td><td>11.2%</td></tr>
    <tr class="t1"><td>T1 · Standout</td><td class="mono">235</td><td>midday #2</td><td>12</td><td>1.0%</td></tr>
    <tr class="t1"><td>T1 · Standout</td><td class="mono">347</td><td>eve #4</td><td>11</td><td>8.2%</td></tr>
    <tr class="t1"><td>T1 · Standout</td><td class="mono">145</td><td>allday #2</td><td>10</td><td>5.6%</td></tr>
    <tr class="t1"><td>T1 · Standout</td><td class="mono">489</td><td>eve #3</td><td>10</td><td>8.9%</td></tr>
    <tr class="t1"><td>T1 · Standout</td><td class="mono">239</td><td>midday #3</td><td>10</td><td>1.6%</td></tr>
    <tr class="t2"><td><b>T2 · Convergence</b></td><td class="mono">049</td><td>allday #1 · eve #2</td><td>6</td><td>allday <b>17.5%</b> ◀ top model</td></tr>
    <tr class="t2"><td>T2 · Convergence</td><td class="mono">358</td><td>eve #6 · midday #4</td><td>6</td><td>—</td></tr>
    <tr class="t2"><td>T2 · Overdue</td><td class="mono">137</td><td>midday #1</td><td>6</td><td>3.5%</td></tr>
  </table>
</div>
...
<div class="sec">
  ...
  <div class="play">
    ...
    <span class="small muted">Only pick that is T1 footprint (10) AND cross-scope convergence (eve+allday) AND high model prob (allday 15.7%). Strongest all-around evidence today.</span>
  </div>
  <div class="play" style="margin-top:8px">
    ...
    <span class="small muted">Highest calibrated probability today (allday 17.5%) and an allday+evening convergence pick. Shares 0/9 with the primary — overlapping coverage if you prefer a single ticket.</span>
  </div>
...
<div class="sec">
  ...
  <ul class="flags small">
    <li><b>Calibration is 13 days old</b> (fitted 6/11) — refit due: <span class="mono">npm run calibrate:picks</span>. Top bucket over-predicts ~5pp → read 17.5% / 15.7% as ~12% / 11% real.</li>
    <li><b>Midday is structurally weak today</b>: calibrated P(hit) 1.0–3.6% (vs allday up to 17.5%). Pick #1 <span class="mono">137</span> is overdue/modest footprint while the 19-footprint <span class="mono">236</span> sits at slate #6 — the known rank-inversion / popularity-ceiling pattern, not an import regression.</li>
